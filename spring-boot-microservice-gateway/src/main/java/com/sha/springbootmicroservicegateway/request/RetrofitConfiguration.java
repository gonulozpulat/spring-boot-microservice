...
public class RetrofitConfiguration {
    ...
    /*product.service.url: application properties definition microservice url*/
    @Bean
    public IProductServiceRequest productServiceRequest(Retrofit.Builder secureKeyBuilder, @Value("${product.service.url}") String baseUrl) {
        return secureKeyBuilder.baseUrl(baseUrl).build().create(IProductServiceRequest.class);
